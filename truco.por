programa {
  ...
  cadeia baralho[40]
  cadeia cartasjogador1[3], cartasjogador2[3], cartasEscolhidas[6]
  inteiro aux=0, aux2, pontosjogador1 = 0, pontosjogador2 = 0, rodada
  ...
  funcao cartasjogo() {
    ...
    para (inteiro i = 0; i < 6; i++) {
      ...
      se(cartasEscolhidas[i]==baralho[maojogo]){
        iguais = verdadeiro
      }
    
      se(iguais==falso){
        cartasEscolhidas[aux] = baralho[maojogo]
        aux++
      }
    }
    escreva(cartasEscolhidas)
  }
}